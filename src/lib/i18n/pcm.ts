...
/**
 * Nigerian Pidgin. AWAITING FIRST-LANGUAGE REVIEW.
 *
 * This file is deliberately empty.
 *
 * The submission states that we will not ship machine translation, and text
 * produced without a Nigerian Pidgin speaker checking it is machine translation
 ...
 */
export const pcm: Partial<Dictionary> = {}
