...
/**
 * Hausa. AWAITING FIRST-LANGUAGE REVIEW.
 *
 * This file is deliberately empty.
 *
 * The submission states that we will not ship machine translation, and text
 * produced without a Hausa speaker checking it is machine translation whatever
 * tool produced it. Until a first-language speaker fills this in, every string
 * falls back to English and the language selector says so.
 *
